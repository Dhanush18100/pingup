        ...
        <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
            ...
            <div className='flex gap-4 pb-5'>
                ...
                {stories.map((story, index) => (
                    <div onClick={()=>setViewStory(story)} key={index} className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-indigo-800 active:scale-95`}>
                        <img className='absolute size-8 top-3 left-3 z-10 rounded-full ring ring-gray-100 shadow
                    ' src={story.user.profile_picture} alt="" />
               ...
               {/* Add a story model  */}
               {
                showModel && <StoryModel setShowModal={setShowModal} fetchStories={fetchStories}/>
               }
               {/* view story model */}

...
import Story from "../models/Stroy.js";
import Message from "../models/Message.js";

// Create a client to send and receive events
export const inngest = new Inngest({ id: "pingup-app" });

//Ingest function to create data to db
...
const sendNewConnectionRequestReminder = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-connection-request-mail', async () => {
            const connection = await Connection.findBy(connectionId).populate('from_user_id to_user_id')
            ...
            <h2>Hi ${connection.to_user_id.full_name},</h2>
                ...
                <p>
                    Thanks,<br/>
                    <strong>PingUp</strong> – Stay Connected
                </p>
                </div>
                `;
            await sendEmail({
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    { cron: "TZ=America/New_York 0 9 * * *" }, //evey day at 9 AM
    async ({ step }) => {
